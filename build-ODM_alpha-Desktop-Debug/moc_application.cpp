...
QT_MOC_LITERAL(1, 12, 12), // "requestState"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 8), // "getState"
QT_MOC_LITERAL(4, 35, 21), // "QVector<QVariantMap>*"
QT_MOC_LITERAL(5, 57, 15), // "QReadWriteLock*"
QT_MOC_LITERAL(6, 73, 11) // "updateState"

    },
    "Application\0requestState\0\0getState\0"
...
void Application::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->requestState(); break;
        case 1: _t->getState((*reinterpret_cast< QVector<QVariantMap>*(*)>(_a[1])),(*reinterpret_cast< QReadWriteLock*(*)>(_a[2]))); break;
        case 2: { bool _r = _t->updateState();
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Application::requestState)) {
                *result = 0;
            }
        }
    }
